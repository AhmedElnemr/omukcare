...
class Coupons extends MY_Controller{
    private $folder = "coupons";
    private $con    = "admin-coupons";
    ...
    public  function index(){
        ...
        $data['metadiscription'] = $data['metakeyword'] = $data['title'] = 'الكوبونات';
    ...
    public  function create(){
        ...
        if ($this->input->post('INSERT') == "INSERT") {
			...
			$Idata['from_date'] = strtotime($Idata['from_date']);
			$Idata['to_date'] = strtotime($Idata['to_date']);
    ...
    public function user_coupons(){
		...
		$data['metadiscription'] = $data['metakeyword'] = $data['title'] = 'الكوبونات المستخدمة';
		$data["my_footer"] = ['table'];
