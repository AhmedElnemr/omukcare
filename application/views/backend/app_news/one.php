...
<div class="m-portlet__body">
	...
	<div class="form-group m-form__group row">
		<div class="col-lg-4">
			<label>تاريخ الخبر (es):</label>
			<input type="date" name="Tdata[news_date]" value="<?= $out["news_date"] ?>" class="form-control" data-validation="required">
	...
	<div class="form-group m-form__group row">
		<div class="col-lg-4">
			<label>تفاصيل الخبر (ar):</label>
			<textarea name="Pdata[ar][content]" class="form-control" rows="8" data-validation="required">
                <?= $out["ar"]["content"] ?>
            </textarea>
		</div>
		<div class="col-lg-4">
			<label>تفاصيل الخبر (en):</label>
			<textarea name="Pdata[en][content]" class="form-control" rows="8" data-validation="required">
                <?= $out["en"]["content"] ?>
            </textarea>
		</div>
		<div class="col-lg-4">
			<label>تفاصيل الخبر (es):</label>
			<textarea name="Pdata[es][content]" class="form-control" rows="8" data-validation="required">
                <?= $out["es"]["content"] ?>
            </textarea>
		</div>
	</div>
