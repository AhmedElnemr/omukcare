...
<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
	<tr>
		<td align="left" valign="top" width="100%"
			...
			<center>
				<img src="<?=base_url().LOGO_TECNOLOGY_EN?>"
		...
		<td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
			<center>
				<table cellspacing="0" cellpadding="0" width="600" class="w320">
					...
					<tr>
						<td class="free-text">
							We'll let you know as soon as your Order. To change or view your order, please view your
					...
					<tr>
						<td class="button">
							<div><!--[if mso]>
								...
								<![endif]--><a href="<?= base_url() . "profile/" . $order->user_id ?>"
											...
											<tr>
												<td class="mini-block-padding">
													<table cellspacing="0" cellpadding="0" width="100%"
														...
														<tr>
															<td class="mini-block">
																<span class="header-sm">Client Address</span><br/>
													...
													<table cellspacing="0" cellpadding="0" width="100%"
														...
														<tr>
															<td class="mini-block">
																...
																<?=date("Y-m-d H:s",$order->order_time)?> <br/>
																<br/>
								...
								<tr>
									<td class="item-col item">
										<table cellspacing="0" cellpadding="0" width="100%">
											<tr>
												<td class="mobile-hide-img">
													<?=(isset($order->service_titles->title))? $order->service_titles->title :"";?>
												</td>
											</tr>
										</table>
									</td>
				...
				<table cellspacing="0" cellpadding="0" width="600" class="w320">
					<tr>
						<td style="padding: 25px 0 25px">
							<strong>DayStar</strong><br/>
							Villa 381 First Settlement Six neighborhood,
							<br/> New Cairo,
							<br/> Egypt
							 <br/><br/>
						</td>
