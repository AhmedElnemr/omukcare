...
class Google_maps
{
    ...
    var $apiKey = 'AIzaSyDWL4T8WERSHrXQ464jk8pKQf_0WLiDbgE';                        // If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
