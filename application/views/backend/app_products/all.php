        ...
        <table id="myTable" class="table table-bordered table-striped">
            ...
            <?php $x = 1; foreach($data_table as $row):?>
                <tr>
                    ...
                    <td>
						<a href="<?= base_url() . "app-products/offers/" . $row->id ?>">
							<button type="button" class="btn m-btn--pill btn-success btn-sm" title="العروض  ">
								<i class="fa fa-pen-alt fa-xs"></i></button>
						</a>
					</td>
                    <td class="text-center">
                        <a href="<?= base_url() . "app-products/edit/" . $row->id ?>">
