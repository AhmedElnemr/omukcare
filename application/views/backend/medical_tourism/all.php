            ...
            <?php $x = 1; foreach($data_table as $row):?>
                <tr>
                    ...
                    <td class="text-center">
                        <a href="<?=base_url()."admin-medical-tourism/edit/".$row->id?>">
                            <button type="button" class="btn m-btn--pill btn-info btn-sm" title="تعديل ">
                                <i class="fa fa-pen-alt fa-xs"></i></button></a>
                        <a href="<?=base_url()."admin-medical-tourism/delete/".$row->id?>" onclick="return confirm('هل انت متأكد من عملية الحذف ؟');">
