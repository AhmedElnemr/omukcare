...
<div class="m-portlet__body">
    <div class="form-group m-form__group row">
        <div class="col-lg-6">
            <label>الاسم :</label>
            <input type="text" name="Pdata[ar_city_title]" value="<?= $out['ar_city_title'] ?>" class="form-control m-input"
        ...
        <div class="col-lg-6">
            ...
            <?php
            if(isset($countries)){
                echo   makeSelect('Pdata[country_id]',$countries , 'id_country' ,'ar_name',$out["country_id"]);
            }
            else{
                echo   makeSelect('Pdata[country_id]',[] , 'id_country' ,'ar_name',$out["country_id"]);
            }
            ?>
        </div>
    </div>
