<?php
class MainDep extends MY_Controller{
	private $folder = "app_main_dep";
	private $con    = "app-main-dep";
	...
	public  function index(){
		...
		$data["data_table"] = $this->Cmodel->get_many_by(["level"=>1]);
		$data['metadiscription'] = $data['metakeyword'] = $data['title'] = 'الأقسام الرئيسية ';
	...
	public function deleted(){
		...
		$data['metadiscription'] = $data['metakeyword'] = $data['title'] = ' الأقسام الرئيسية المحذوفة ';
		$data["my_footer"] = ['table'];
